...
var displayMap = exports.displayMap = function displayMap(locations) {
  ...
  locations.forEach(function (loc, index) {
    console.log("Adding location ".concat(index, ":"), loc);

    // Validate coordinates
    if (!loc.coordinates || loc.coordinates.length < 2) {
      console.error("Invalid coordinates for location ".concat(index));
      return;
    }
    ...
    marker.bindPopup("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>"), {
      maxWidth: 250,
      // Match your CSS max-width: 25rem
...
const VERSION = exports.VERSION = "1.12.1";
...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data, type) {
    var url, res, user, userPhotoEl, navPhotoEl, photoInput, _err$response, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
        ...
        case 1:
          ...
          if (res.data.status === 'success') {
            ...
            if (type === 'data') {
              user = res.data.data.user; // Update profile photo in settings form
              userPhotoEl = document.querySelector('.form__user-photo');
              if (userPhotoEl && user.photo) {
                userPhotoEl.src = "/img/users/".concat(user.photo, "?").concat(Date.now());
              }

              // Update navigation photo
              navPhotoEl = document.querySelector('.nav__user-img');
              if (navPhotoEl && user.photo) {
                navPhotoEl.src = "/img/users/".concat(user.photo, "?").concat(Date.now());
              }
...
var stripe = Stripe('pk_test_51S7VTkIzfSrI1uRsKz5vMB5M2efDrjFtPPIqlfc4lp8F11sHjliViQuUDYriYafft7xUI5u1wbh0jVbay9YgN2w900dB0BaYxQ');
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    var res, session, result, message, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
        ...
        case 1:
          ...
          (0, _alerts.showAlert)('info', 'Creating your booking session...');
        ...
        case 4:
          ...
          (0, _alerts.showAlert)('success', 'Redirecting to payment page...');
        ...
        case 7:
          ...
          if (_t.response) {
            ...
            console.log('Server error response:', _t.response.data);
            if (_t.response.status === 401) {
              message = 'You need to log in to book a tour!';
              // Redirect to login after showing error
              setTimeout(function () {
                window.location.assign('/login');
              }, 2000);
            } else if (_t.response.status === 404) {
              message = 'Tour not found!';
            } else if (_t.response.data && _t.response.data.message) {
              message = _t.response.data.message;
            }
          } else if (_t.message.includes('Stripe')) {
            message = "Payment error: ".concat(_t.message);
          } else if (_t.message) {
            message = _t.message;
          }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"wishlist.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.updateWishlistButton = exports.toggleWishlist = exports.removeFromWishlist = exports.initWishlistButtons = exports.checkWishlistStatus = exports.addToWishlist = void 0;
var _axios = _interopRequireDefault(require("axios"));
var _alerts = require("./alerts");
function _interopRequireDefault(e) { return e && e.__esModule ? e : { default: e }; }
function _regenerator() { /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */ var e, t, r = "function" == typeof Symbol ? Symbol : {}, n = r.iterator || "@@iterator", o = r.toStringTag || "@@toStringTag"; function i(r, n, o, i) { var c = n && n.prototype instanceof Generator ? n : Generator, u = Object.create(c.prototype); return _regeneratorDefine2(u, "_invoke", function (r, n, o) { var i, c, u, f = 0, p = o || [], y = !1, G = { p: 0, n: 0, v: e, a: d, f: d.bind(e, 4), d: function d(t, r) { return i = t, c = 0, u = e, G.n = r, a; } }; function d(r, n) { for (c = r, u = n, t = 0; !y && f && !o && t < p.length; t++) { var o, i = p[t], d = G.p, l = i[2]; r > 3 ? (o = l === n) && (u = i[(c = i[4]) ? 5 : (c = 3, 3)], i[4] = i[5] = e) : i[0] <= d && ((o = r < 2 && d < i[1]) ? (c = 0, G.v = n, G.n = i[1]) : d < l && (o = r < 3 || i[0] > n || n > l) && (i[4] = r, i[5] = n, G.n = l, c = 0)); } if (o || r > 1) return a; throw y = !0, n; } return function (o, p, l) { if (f > 1) throw TypeError("Generator is already running"); for (y && 1 === p && d(p, l), c = p, u = l; (t = c < 2 ? e : u) || !y;) { i || (c ? c < 3 ? (c > 1 && (G.n = -1), d(c, u)) : G.n = u : G.v = u); try { if (f = 2, i) { if (c || (o = "next"), t = i[o]) { if (!(t = t.call(i, u))) throw TypeError("iterator result is not an object"); if (!t.done) return t; u = t.value, c < 2 && (c = 0); } else 1 === c && (t = i.return) && t.call(i), c < 2 && (u = TypeError("The iterator does not provide a '" + o + "' method"), c = 1); i = e; } else if ((t = (y = G.n < 0) ? u : r.call(n, G)) !== a) break; } catch (t) { i = e, c = 1, u = t; } finally { f = 1; } } return { value: t, done: y }; }; }(r, o, i), !0), u; } var a = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} t = Object.getPrototypeOf; var c = [][n] ? t(t([][n]())) : (_regeneratorDefine2(t = {}, n, function () { return this; }), t), u = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(c); function f(e) { return Object.setPrototypeOf ? Object.setPrototypeOf(e, GeneratorFunctionPrototype) : (e.__proto__ = GeneratorFunctionPrototype, _regeneratorDefine2(e, o, "GeneratorFunction")), e.prototype = Object.create(u), e; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, _regeneratorDefine2(u, "constructor", GeneratorFunctionPrototype), _regeneratorDefine2(GeneratorFunctionPrototype, "constructor", GeneratorFunction), GeneratorFunction.displayName = "GeneratorFunction", _regeneratorDefine2(GeneratorFunctionPrototype, o, "GeneratorFunction"), _regeneratorDefine2(u), _regeneratorDefine2(u, o, "Generator"), _regeneratorDefine2(u, n, function () { return this; }), _regeneratorDefine2(u, "toString", function () { return "[object Generator]"; }), (_regenerator = function _regenerator() { return { w: i, m: f }; })(); }
...
var addToWishlist = exports.addToWishlist = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    var res, _err$response, _err$response2, message, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          ...
          return (0, _axios.default)({
            method: 'POST',
            url: "/api/v1/wishlist/add/".concat(tourId),
        ...
        case 3:
          _context.p = 3;
          _t = _context.v;
          console.error('❌ Add to wishlist error:', _t);
          message = 'Failed to add to wishlist. Please try again.';
          if (((_err$response = _t.response) === null || _err$response === void 0 ? void 0 : _err$response.status) === 401) {
            message = 'Please log in to add tours to your wishlist!';
          } else if ((_err$response2 = _t.response) !== null && _err$response2 !== void 0 && (_err$response2 = _err$response2.data) !== null && _err$response2 !== void 0 && _err$response2.message) {
            message = _t.response.data.message;
          }
          (0, _alerts.showAlert)('error', message);
...
var removeFromWishlist = exports.removeFromWishlist = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(tourId) {
    var res, _err$response3, message, _t2;
    return _regenerator().w(function (_context2) {
      while (1) switch (_context2.p = _context2.n) {
        case 0:
          _context2.p = 0;
          ...
          return (0, _axios.default)({
            method: 'DELETE',
            url: "/api/v1/wishlist/remove/".concat(tourId),
            withCredentials: true
          });
        case 1:
          res = _context2.v;
        ...
        case 3:
          _context2.p = 3;
          _t2 = _context2.v;
          console.error('❌ Remove from wishlist error:', _t2);
          message = 'Failed to remove from wishlist. Please try again.';
          if ((_err$response3 = _t2.response) !== null && _err$response3 !== void 0 && (_err$response3 = _err$response3.data) !== null && _err$response3 !== void 0 && _err$response3.message) {
            message = _t2.response.data.message;
          }
          (0, _alerts.showAlert)('error', message);
  ...
  return function removeFromWishlist(_x2) {
    return _ref2.apply(this, arguments);
  };
}();

// Check if tour is in wishlist
var checkWishlistStatus = exports.checkWishlistStatus = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(tourId) {
    var res, _t3;
    return _regenerator().w(function (_context3) {
      while (1) switch (_context3.p = _context3.n) {
        case 0:
          ...
          return (0, _axios.default)({
            method: 'GET',
            url: "/api/v1/wishlist/check/".concat(tourId),
            withCredentials: true
          });
        case 1:
          res = _context3.v;
          ...
          return _context3.a(2, res.data.data.inWishlist);
        case 2:
          return _context3.a(2, false);
        case 3:
          _context3.p = 3;
          _t3 = _context3.v;
          console.error('❌ Check wishlist status error:', _t3);
          return _context3.a(2, false);
      }
    }, _callee3, null, [[0, 3]]);
  }));
  return function checkWishlistStatus(_x3) {
    return _ref3.apply(this, arguments);
  };
}();

// Toggle wishlist status
var toggleWishlist = exports.toggleWishlist = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4(tourId, button) {
    var isInWishlist, success;
    return _regenerator().w(function (_context4) {
      while (1) switch (_context4.n) {
        case 0:
          isInWishlist = button.classList.contains('wishlist-btn--active'); // Update button state immediately for better UX
          ...
          _context4.n = 1;
          return removeFromWishlist(tourId);
        case 1:
          success = _context4.v;
          _context4.n = 4;
          break;
  ...
  return function toggleWishlist(_x4, _x5) {
    return _ref4.apply(this, arguments);
  };
}();

// Update button appearance
var updateWishlistButton = exports.updateWishlistButton = function updateWishlistButton(button, isInWishlist, isLoading) {
  var icon = button.querySelector('.wishlist-btn__icon');
  var text = button.querySelector('.wishlist-btn__text');
  if (isLoading) {
...
var initWishlistButtons = exports.initWishlistButtons = /*#__PURE__*/function () {
    ...
    return _regenerator().w(function (_context7) {
      while (1) switch (_context7.n) {
        case 0:
          ...
          _context7.n = 1;
          return Promise.all(Array.from(wishlistButtons).map(/*#__PURE__*/function () {
            var _ref6 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(button) {
              var tourId, isInWishlist;
              return _regenerator().w(function (_context6) {
                while (1) switch (_context6.n) {
                  case 0:
                    tourId = button.dataset.tourId;
                    if (tourId) {
                      _context6.n = 1;
                      break;
                    }
                  ...
                  case 1:
                    _context6.n = 2;
                    return checkWishlistStatus(tourId);
                  case 2:
                    isInWishlist = _context6.v;
                    updateWishlistButton(button, isInWishlist, false);
                        ...
                        return _regenerator().w(function (_context5) {
                          while (1) switch (_context5.n) {
                            case 0:
                              ...
                              e.stopPropagation();
                              _context5.n = 1;
                              return toggleWishlist(tourId, button);
                            case 1:
  ...
  return function initWishlistButtons() {
...
var logOutBtns = document.querySelectorAll('.nav__el.nav__el--logout');
var userDataForm = document.querySelector('.form-user-data');
var userPasswordForm = document.querySelector('.form-user-password');
var bookBtn = document.getElementById('book-tour'); // Single button, not multiple
...
function initBookingButton() {
  ...
  var btn = document.getElementById('book-tour');
  if (!btn) {
  ...
  // Add new listener
  freshBtn.onclick = /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3(e) {
      var tourId, oldText, res, data, stripe, result, _t;
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.p = _context3.n) {
          case 0:
            e.preventDefault();
          ...
          case 1:
            ...
            // API call
            _context3.n = 3;
            return fetch('/api/v1/booking/checkout-session/' + tourId, {
              method: 'GET',
              credentials: 'include'
            });
          case 3:
          ...
          case 4:
            ...
            // Redirect to Stripe
            stripe = Stripe('pk_test_51S7VTkIzfSrI1uRsKz5vMB5M2efDrjFtPPIqlfc4lp8F11sHjliViQuUDYriYafft7xUI5u1wbh0jVbay9YgN2w900dB0BaYxQ');
            _context3.n = 5;
            return stripe.redirectToCheckout({
          ...
          case 9:
            _context3.p = 9;
            _t = _context3.v;
            console.error('❌ Booking failed:', _t);
            this.textContent = oldText;
            this.disabled = false;
            alert('Booking failed: ' + _t.message);
          case 10:
            return _context3.a(2);
        }
      }, _callee3, this, [[2, 9]]);
